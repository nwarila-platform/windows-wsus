...
**Status: scaffolding.** Logic lands one command per strict-cycle piece — see
`_handoff/QUEUE.md` (repo root) for the build queue.
...
| Key | Default | Purpose |
|-----|---------|---------|
| _none yet_ | | populated per build piece, same cycle it lands |
